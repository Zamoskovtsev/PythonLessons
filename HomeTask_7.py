...
# def HonneyTrueFalse(line):
#     vowelletters=['а', 'о','у', 'ы', 'и', 'э', 'я', 'ю', 'ё', 'е']
#     Flag='true'
#     lst1=line.split()
#     slog=[]
#     strhoney=[]
...
#             if ct2!=0:
#                 word[vl]=ct2
#         strhoney.append(word)
#         slog.append(count)
#         if slog[i]!=slog[i-1]:
#            Flag='false'
#     return Flag, strhoney

# print(HonneyTrueFalse("пара-ра-рам рам-пам-папам па-ра-па-дам")) #-> True
# print(HonneyTrueFalse("пара-ра-рам рам-пум-пупам па-ре-по-дам")) #-> True
# print(HonneyTrueFalse("пара-ра-рам рам-пуум-пупам па-ре-по-дам")) #-> False
# print(HonneyTrueFalse("Трам-пара-папам-парам-па-пам-пам-па Пум-пурум-пу-пурум-трам-пам-па")) #-> False
# print(HonneyTrueFalse("Пам-парам-пурум Пум-пурум-карам")) #-> True
...
def print_operation_table(func,x,y):
    ...
    for idx in range(x):
        print(f"{idx+1:<2}|", end=" ")
        for jdx in range(y):
            print (f"{func((idx+1),(jdx+1)):<2}", end=" ")
        print()
    return
